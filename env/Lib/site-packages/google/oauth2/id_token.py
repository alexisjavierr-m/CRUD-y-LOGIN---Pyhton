...
def verify_oauth2_token(id_token, request, audience=None, clock_skew_in_seconds=10):
...
def verify_firebase_token(id_token, request, audience=None, clock_skew_in_seconds=10):
